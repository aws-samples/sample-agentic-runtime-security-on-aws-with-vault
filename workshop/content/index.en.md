...
Before deploying any infrastructure, run `infrastructure/scripts/check-prerequisites.sh` (consolidated install + Bedrock + quotas + IAM checks) then `infrastructure/scripts/bootstrap.sh <HCP_ORG>`.
:::
