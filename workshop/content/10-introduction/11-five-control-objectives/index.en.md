...
5. **Correlated audit evidence** — a single propagated `request_id` joins IVIA decision logs, HashiCorp Vault audit logs (carrying the agent-registry identity), and RDS pgaudit logs in Athena.
